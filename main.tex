...
The above factors can produce significant variability in timing measurements \TODO{cite}.
Timing variations due to external factors can have perplexing correlation structures (see
\TODO{Fig 1}), and can be difficult to distinguish from timing variations due to genuine
...
the scope of the benchmark program. % "and thus can be burdensome to implement in practice." Maybe too harsh?
