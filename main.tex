...
configuration which maximizes $t_P$ to some value $[t_P]_{\textrm{max}} \le t_{P_0} + k
...
Section~\ref{sec:environment}, is not easily controlled in practice. The upper bound of the delay
