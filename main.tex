...
in turn, the final runtime estimate. Third, measurements made later in the experiment can
repeat the benchmark more times than is necessary to overcome timer error, constituting an
inefficient use of experimenter time.
