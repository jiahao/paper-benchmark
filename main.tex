...
Another approach focuses on repeating benchmarks enough times that the execution times of
the iterations become i.i.d.~\cite{Kalibera2013}. Their approach is largely
