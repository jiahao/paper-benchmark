...
\TODO{should the notation section be an appendix instead of a section in the middle of the paper?}
...
\newpage % necessary since forcing inlining via H doesn't work for algorithms in two-column mode
